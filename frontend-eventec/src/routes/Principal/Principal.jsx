        ...
        <Container>
            <Row>
                <Col>
                    ...
                    {eventos.map((evento) => {
                      <EventCard nombre={evento.nombre} fecha={evento.fecha} lugar={evento.lugar} personasInscritas={evento.personasInscritas} cupos={evento.cupos} duracion={evento.duracion} esAsocia={!userDetails.tipoUsuario} estaInscrito={evento.estaInscrito} descripcion={evento.descripcion} />
                    })}
